...
//base url
String url =
    'https://navi.enterprises/'; //please add the '/' at the end of the url as 'https://yourwebsite.com/'
String mapkey = 'AIzaSyCrHecilt7dkF-LVBbtAAi2LPVEjBkK2xw';
String mapStyle = '';
